...
public class CEnumChar {
    ...
    public static final int _MIN_CHAR_EN_ = 32;
    ...
    public static boolean EnumCharacter(String strFileName, Font usingFont) {
        ...
        try {
            readerStream = new InputStreamReader(inStream, "UTF-16");
        } catch (Exception ex) {
            return false;
        }
        ...
        try {
            ...
            while (currChar != -1) {
                //Skip Controlling-Chars or UTF-16 Flag Char (2 first bytes of UTF-16 text file)
                ...
                if (!IsInEnum(currObjChar, m_vEnumText)) {
                    ...
                    if  ((currObjChar.charValue() == ' ') || (usingFont.canDisplay(currObjChar.charValue()) && !Character.isWhitespace(currObjChar.charValue()) && !Character.isISOControl(currObjChar.charValue()))) {
...
//        try {
//            writerStream = new OutputStreamWriter(outStream, "UTF-16");
//        } catch (Exception ex) {
//            return false;
//        }
//        
