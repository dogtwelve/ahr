...
int ZEXPORT inflateInit2_( voidpf global, z_streamp z, int w, const char *version, int stream_size )
{
...
int ZEXPORT inflateInit_( voidpf global, z_streamp z, const char *version, int stream_size )
{
  return inflateInit2_( global, z, DEF_WBITS, version, stream_size);
}
